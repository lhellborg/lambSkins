			  	...
			  	'<div class="modal-dialog">'+
			   		 '<div class="modal-content">'+
			      		...
			      		'<form is="iron-form" id="form">' +
							  ...
							  '<paper-input type="text" label="Min emiladress" required auto-validate autocomplete="on" autofocus error-message="Fyll i din emailadress om du vill reservera" id="reserveratMail'+nr+'" class="accountRequired"></paper-input>' +
